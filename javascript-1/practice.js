...
const me = {
	...
	age: 25,
	greeter: function() {
		return `Hello! My name is ${me.firstName} and I live in ${Utah}`
	}
...
let total = myNumbers.reduce(function(a, e){
	return a += e
})
...
let totallyAwesome = people.reduce(function(a, e){
	return a += e.awesomeLevel
}, 0)
